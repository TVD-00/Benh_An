...
export const generateTienPhauDocx = async (data) => {
    try {
        ...
        const doc = new Document({
            ...
            sections: [{
                ...
                children: [
                    ...
                    ...(hasText(data.benhNgoaiCoNang)
                        ? [
                            createHeading("a) ", "Cơ năng:", { spacing: { before: 20, after: 0 } }),
                            ...splitLinesToParas(data.benhNgoaiCoNang),
                        ]
                        : []
                    ),
                    ...(hasText(data.benhNgoaiThucThe)
                        ? [
                            createHeading("b) ", "Thực thể:", { spacing: { before: 20, after: 0 } }),
                            ...splitLinesToParas(data.benhNgoaiThucThe),
                        ]
                        : []
                    ),
                    ...(hasText(data.benhNgoaiNghiemPhap)
                        ? [
                            createHeading("c) ", "Các nghiệm pháp:", { spacing: { before: 20, after: 0 } }),
                            ...splitLinesToParas(data.benhNgoaiNghiemPhap),
                        ]
                        : []
                    ),
